...
class EmailSelectColorSec extends StatefulWidget {
  const EmailSelectColorSec({super.key});

  @override
  State<EmailSelectColorSec> createState() => _SelectColorSectionState();
}

class _SelectColorSectionState extends State<EmailSelectColorSec> {
  List<dynamic> colors = [
