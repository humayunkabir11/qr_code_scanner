...
class FavoriteFileDownloadScreen extends StatefulWidget {
  const FavoriteFileDownloadScreen({super.key});

  @override
  State<FavoriteFileDownloadScreen> createState() => _QrCodeScreenState();
}

class _QrCodeScreenState extends State<FavoriteFileDownloadScreen> {
