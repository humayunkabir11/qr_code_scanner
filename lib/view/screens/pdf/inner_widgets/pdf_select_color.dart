...
class PdfSelectColors extends StatefulWidget {
  const PdfSelectColors({super.key});

  @override
  State<PdfSelectColors> createState() => _SelectColorSectionState();
}

class _SelectColorSectionState extends State<PdfSelectColors> {
  List<dynamic> colors = [
