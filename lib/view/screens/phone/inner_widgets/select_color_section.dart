...
class PhoneSelectColorSection extends StatefulWidget {
  const PhoneSelectColorSection({super.key});

  @override
  State<PhoneSelectColorSection> createState() => _SelectColorSectionState();
}

class _SelectColorSectionState extends State<PhoneSelectColorSection> {
  List<dynamic> colors = [
