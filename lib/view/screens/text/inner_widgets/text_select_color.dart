...
class TextSelectColor extends StatefulWidget {
  const TextSelectColor({super.key});

  @override
  State<TextSelectColor> createState() => _SelectColorSectionState();
}

class _SelectColorSectionState extends State<TextSelectColor> {
  List<dynamic> colors = [
