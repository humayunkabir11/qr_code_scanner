...
class SelectColorSections extends StatefulWidget {
  const SelectColorSections({super.key});

  @override
  State<SelectColorSections> createState() => _SelectColorSectionState();
}

class _SelectColorSectionState extends State<SelectColorSections> {
  List<dynamic> colors = [
